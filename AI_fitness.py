...
with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5, model_complexity=2) as Pose:
    ...
    while cap.isOpened():
        ...
        #fps = int(fps)
        #fps = str(fps)
        #cv2.putText(image, fps, (7, 70), cv2.FONT_HERSHEY_TRIPLEX, 3, (100, 255, 0), 3, cv2.LINE_AA)
        ...
        try:
            ...
            if (BMI <= 18.5):
                ...
                if frame_cnt < 100:
                    cv2.putText(image, 'You are underweight,your BMI-'+ str(BMI),(0, 155), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0), 1,
                               cv2.LINE_AA)
            ...
            if (18.5 < BMI < 25):
                ...
                if frame_cnt < 100:
                    cv2.putText(image, 'You are Healthy ,your BMI-'+ str(BMI),(0, 155), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0), 1,
                                cv2.LINE_AA)
                    cv2.putText(image, 'Do Shoulder and squats Exercise to stay Healthy', (10, 205), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0), 1,
                               cv2.LINE_AA)
            ...
            if (BMI > 25 ):
                ...
                if frame_cnt < 100:
                    cv2.putText(image, 'You are Over weight,your BMI-'+ str(BMI),(0, 155), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0), 1,
                                cv2.LINE_AA)
                    cv2.putText(image, 'Do pushups and squats Exercise for weight loss', (10, 205), cv2.FONT_HERSHEY_TRIPLEX, 1, (0, 0, 0), 1,
                               cv2.LINE_AA)
           ...
           pass
        # screen = cv2.resize(image, (1000, 1000))
